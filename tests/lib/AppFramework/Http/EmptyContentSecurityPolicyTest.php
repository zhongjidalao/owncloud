...
class EmptyContentSecurityPolicyTest extends TestCase {
	...
	public function testGetAllowedFrameDomain() {
		$expectedPolicy = "default-src 'none';manifest-src 'self';frame-src www.owncloud.com";
	...
	public function testGetPolicyFrameDomainValidMultiple() {
		$expectedPolicy = "default-src 'none';manifest-src 'self';frame-src www.owncloud.com www.owncloud.org";
	...
	public function testGetAllowedFrameAncestorDomain() {
		$expectedPolicy = "default-src 'none';frame-ancestors owncloud.com";
	...
	public function testGetPolicyFrameAncestorValidMultiple() {
		$expectedPolicy = "default-src 'none';frame-ancestors owncloud.com owncloud.org";
